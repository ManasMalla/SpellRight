package com.manasmalla.spellright.utils;
...
public class CircularProgressBar extends View {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                ...
                0, 0);
        mStrokeWidth = a.getInteger(R.styleable.CircularProgressBar_mStrokeWidth, 20);
        mProgressColor = a.getColor(R.styleable.CircularProgressBar_mProgressColor, Color.BLACK);
        mProgress = a.getInteger(R.styleable.CircularProgressBar_mProgress, 0);
    }
